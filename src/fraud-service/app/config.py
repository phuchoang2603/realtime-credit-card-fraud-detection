...
def settings_from_env() -> Settings:
    testing = _env_bool("TESTING_MODE", False)
    ...
    settings = Settings(
        ...
        metrics_enabled=not testing and _env_bool("METRICS_ENABLED", True),
        metrics_port=int(os.environ.get("METRICS_PORT", "8010")),
        graceful_shutdown_timeout=float(os.environ.get("GRACEFUL_SHUTDOWN_TIMEOUT", "30")),
        tracing_enabled=not testing and _env_bool("TRACING_ENABLED", True),
