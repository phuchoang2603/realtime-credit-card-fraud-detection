...
| Quality | [tests](../../src/fraud-service/tests/test_application.py), [CI](../../.github/workflows/ci.yml) | Ruff, focused behavior tests, generated-contract checks and CI-owned process/image verification. Numerical coverage/mutation gates were removed under the simplified verification policy. |
